...
const Dishes = () => {
  ...
  return (
    <>
      <SectionTitle title="Dishes" path="Home | Dishes" />
      <div className="max-w-7xl mx-auto mt-5">
        ...
        <div className="grid grid-cols-4 px-2 gap-y-4 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 dishes-products-grid">
